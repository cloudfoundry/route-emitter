...
type FakeRoutingTable struct {
	SetRoutesStub        func(beforeLRP, afterLRP *models.LRPDeploymentSchedulingInfo) (routingtable.TCPRouteMappings, routingtable.MessagesToEmit)
	setRoutesMutex       sync.RWMutex
	setRoutesArgsForCall []struct {
		beforeLRP *models.LRPDeploymentSchedulingInfo
		afterLRP  *models.LRPDeploymentSchedulingInfo
	}
	...
	RemoveRoutesStub        func(desiredLRP *models.LRPDeploymentSchedulingInfo) (routingtable.TCPRouteMappings, routingtable.MessagesToEmit)
...
func (fake *FakeRoutingTable) SetRoutes(beforeLRP *models.LRPDeploymentSchedulingInfo, afterLRP *models.LRPDeploymentSchedulingInfo) (routingtable.TCPRouteMappings, routingtable.MessagesToEmit) {
...
func (fake *FakeRoutingTable) SetRoutesArgsForCall(i int) (*models.LRPDeploymentSchedulingInfo, *models.LRPDeploymentSchedulingInfo) {
	fake.setRoutesMutex.RLock()
	defer fake.setRoutesMutex.RUnlock()
...
func (fake *FakeRoutingTable) RemoveRoutes(desiredLRP *models.LRPDeploymentSchedulingInfo) (routingtable.TCPRouteMappings, routingtable.MessagesToEmit) {
...
func (fake *FakeRoutingTable) RemoveRoutesArgsForCall(i int) *models.LRPDeploymentSchedulingInfo {
	fake.removeRoutesMutex.RLock()
	defer fake.removeRoutesMutex.RUnlock()
