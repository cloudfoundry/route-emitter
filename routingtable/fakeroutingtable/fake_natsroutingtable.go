...
func (fake *FakeNATSRoutingTable) SwapReturnsOnCall(i int, result1 routingtable.MessagesToEmit) {
	fake.SwapStub = nil
...
func (fake *FakeNATSRoutingTable) SetRoutesReturnsOnCall(i int, result1 routingtable.MessagesToEmit) {
	fake.SetRoutesStub = nil
...
func (fake *FakeNATSRoutingTable) GetRoutesReturnsOnCall(i int, result1 []routingtable.Route) {
	fake.GetRoutesStub = nil
...
func (fake *FakeNATSRoutingTable) RemoveRoutesReturnsOnCall(i int, result1 routingtable.MessagesToEmit) {
	fake.RemoveRoutesStub = nil
...
func (fake *FakeNATSRoutingTable) AddEndpointReturnsOnCall(i int, result1 routingtable.MessagesToEmit) {
	fake.AddEndpointStub = nil
...
func (fake *FakeNATSRoutingTable) RemoveEndpointReturnsOnCall(i int, result1 routingtable.MessagesToEmit) {
	fake.RemoveEndpointStub = nil
...
func (fake *FakeNATSRoutingTable) EndpointsForIndexReturnsOnCall(i int, result1 []routingtable.Endpoint) {
	fake.EndpointsForIndexStub = nil
...
func (fake *FakeNATSRoutingTable) MessagesToEmitReturnsOnCall(i int, result1 routingtable.MessagesToEmit) {
	fake.MessagesToEmitStub = nil
